...
class LoginPage extends Component {
    ...
    changeView(newView) {
        if (newView === 'login') {
            ...
            this.setState({
                view: newView,
                signUpButton: "btn btn-warning btn-block",
                loginButton: "btn btn-outline-warning",
            });
        }
    }
            ...
            <div>
                <div className='switchLoginSign'>
                    <div className="btn-group LoginSignButton" role="group">
                        <button type="button" className={loginButton} onClick={() => this.changeView('login')}>
                            Login
                        </button>
                        <button type="button" className={signUpButton} onClick={() => this.changeView('signup')}>
                            Register
                        </button>
                    </div>
